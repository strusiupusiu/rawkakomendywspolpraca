{
  ...
  "actions": [
    ...
    {
      "title": "Nowe podanie na streamera ${tempVars(\"uzytkowniknick\")}",
      "author": "",
      "color": "RANDOM",
      "url": "",
      "authorIcon": "",
    ...
    },
    {
      "storage": "1",
      "varName": "embed",
      "fieldName": "Nazwa serwera z którym chcesz zawrzeć współpracę:",
    ...
    },
    {
      "storage": "1",
      "varName": "embed",
      "fieldName": "Ping właściciela serwera z którym chcesz zawrzeć współpracę:",
